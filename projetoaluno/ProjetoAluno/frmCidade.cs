...
namespace ProjetoAluno
{
    public partial class frmCidade : Form
    {
        ...
        private void btnNovoRegistro_Click(object sender, EventArgs e)
        {
            ...
            txtNomeCidade.Focus(); btnSalvar.Enabled = true;
        ...
        {
            if (TabControl1.SelectedIndex == 0) { TabControl1.SelectTab(1); }
            ...
            if (MessageBox.Show("Confirma exclusão?", "Yes or No", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) == DialogResult.Yes)
            {
                ...
                if (RegCid.Excluir() > 0)
                {
                    ...
                    Cidade R = new Cidade(); dsCidade.Tables.Clear();
            ...
            else
            {
                ...
                if (bInclusao)
                {
                    if (RegCid.Salvar() > 0)
                    {
                        ...
                        btnSalvar.Enabled = false; txtId.Enabled = false;
                        txtNomeCidade.Enabled = false; cbxEstado.Enabled = false;
                        btnSalvar.Enabled = false; btnAlterar.Enabled = true;
